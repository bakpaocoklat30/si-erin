// ----------------------------------------------------------------------
// 📋 CHANGELOG:
// ✅ Perubahan: Membuat halaman detail siswa bimbingan per kelas di rute `/dashboard/pembimbing/classes/[className]` yang menampilkan daftar lengkap nama siswa beserta informasi industri penempatan PKL.
// ✨ Fitur Baru: Teacher Class Detail Inspector for Pembimbing Role.
// 🎨 UI/UX Update: Grid responsif modern dengan badge status penempatan industri yang jelas.
// 🔧 Bug Fix: Penanganan aman parameter dynamic route kelas untuk role pembimbing.
// 🚀 Inovasi: Dedicated Mentorship Class Inspector Architecture.
// ----------------------------------------------------------------------
...
import { 
  Users, Building2, ArrowLeft, ShieldCheck, AlertCircle, Loader2, Phone, Search, MapPin 
} from 'lucide-react';
import { useTheme } from '@/app/theme-provider';

export default function TeacherClassDetailMainPage() {
  ...
  return (
    <div className={`min-h-screen p-6 sm:p-10 space-y-8 transition-colors duration-300 pb-28 ${
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <button
          type="button"
          onClick={() => router.push('/dashboard/pembimbing')}
